...
ScatterV utilitizes a 5-stage instruction pipeline to improve performance when parallel computing is applied. Every instruction goes through the following stages:
