...
This portion of the project is about converting my functional single cycle RISC-V core into a pipelined core in order to increase the maximum clock speed. A major issue with my first processor a year back was that 
